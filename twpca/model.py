...
class TWPCA(object):
	...
	def create_train_op(self, optimizer):
		...
		elif self.warptype == 'tau':
			trainable_vars -= set(['tau_scale', 'tau_shift'])
		elif self.warptype == 'noscale':
			trainable_vars.remove('scale')
		elif self.warptype == 'noshift':
			trainable_vars.remove('shift')
